...
from CustomerSupportAgent.agent import root_agent
...
flags.DEFINE_bool("update", False, "Creates a new deployment.")
...
def create() -> None:
    ...
    remote_app = agent_engines.create(
        ...
        extra_packages=["./CustomerSupportAgent"],
        display_name="banking_bot_CustomerSupportAgent_v1"
...
def update()-> None:
    ...
    remote_app = agent_engines.update(
        resource_name="projects/<id>/locations/us-central1/reasoningEngines/<id>",
        agent_engine=app,
        requirements=[
        ...
        extra_packages=["./CustomerSupportAgent"],
        display_name="banking_bot_CustomerSupportAgent_v3"
    )
    print(f"Created remote app: {remote_app.resource_name}")
